                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li class="position-static"><a href="#">Category <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Women's Shoes</a>
                                                <ul>
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Men's Shoes</a>
                                                <ul>
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                <a class="menu-title" href="#">Kid's Shoes</a>
                                                <ul>
            ...
            <div class="container pt-15 pb-20">
                <div class="row">
                    ...
                    <div class="col-lg-4 mob-center">
                        <h5 class="widget-title wow fadeIn animated">Payment Method</h5>
                        <div class="row">
